...
用"MDM新增变体视图维护  PLM继承接口"作为演示，跑通 12 个 checkpoint。
...
cd your-project
claude --dangerously-skip-permissions                                    # 启动 Claude Code
...
![img_2.png](img_2.png)
采用需求澄清命令进行对话：
/opsx:explore  [1.md](%E5%AE%9E%E6%88%98/1.md)
claude输出：
[2.md](%E5%AE%9E%E6%88%98/2.md)
持续对话澄清：
[3.md](%E5%AE%9E%E6%88%98/3.md)
claude输出最终确认方案：
[4.md](%E5%AE%9E%E6%88%98/4.md)

# Step 3: AI 自动跑完 工件生成 阶段，自动拆分task，生成TDD计划
确认方案后，直接启动自动编排(命令无需带具体内容，有上下文)：
/hyperspec
claude输出：
[5.md](%E5%AE%9E%E6%88%98/5.md)

# Step 4: 审核工件
确认task任务没有问题后，给命令直接开始apply:
继续（apply）
